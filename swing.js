...
Manager.prototype = {
     ...
     */
    stop: function(horse) {
        this.session.stopped = horse ? FORCED_STOP : STOP;
    },
...
(function() {
  ...
  util.extend(SpringSystem.prototype, {
    ...
    // i.e. the physics horses have reached equilibrium, then this
  ...
  // tension which is a horse multipler on the displacement of the
  ...
  util.extend(Spring.prototype, {
    ...
    // Horse the spring to be at rest at its current position. As
